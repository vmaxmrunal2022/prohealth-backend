...
class TherapyClassController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        if ($request->add_new == 1) {
            ...
            $validator = Validator::make($request->all(), [
                ...
                "termination_date" => ['required|date|after_or_equal:effective_date'],
                "therapy_class" => ['required', 'max:1'],
    ...
    public function getTCItemDetails($ndcid, $ncdid2)
    {
        $ndc = DB::table('TC_EXCEPTION_LISTS')
            ->select(
                'TC_EXCEPTION_LISTS.*',
                'TC_EXCEPTION_LISTS.THER_CLASS_EXCEPTION_LIST as exception_list',
                'TC_EXCEPTIONS.EXCEPTION_NAME as exception_name',
